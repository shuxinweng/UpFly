//
//  DepartingFlightViewController.swift
//  UpFly
//
...
class DepartingFlightViewController: UIViewController {
    
    var roomCode: String?
    weak var delegate: DepartingFlightDelegate?
    ...
    private let dateLabel: UILabel = {
        ...
        label.text = "Departing Date&Time"
    ...
    @objc private func didTapSubmit() {
        ...
        let departureDateTime = dateTimePicker.date

        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "MM/dd/yyyy HH:mm"
        let departureDateTimeString = dateFormatter.string(from: departureDateTime)
        ...
        let flightDocumentPath = "Room/\(roomCode)/flightInfo/departingFlight"
        ...
        db.document(flightDocumentPath).setData(flightData) { error in
            if let error = error {
                ...
                if let delegate = self.delegate {
                    delegate.didSubmitDepartingFlightInfo(airline: airline, airport: airport, departureDateTime: departureDateTimeString)
                }
...
protocol DepartingFlightDelegate: AnyObject {
